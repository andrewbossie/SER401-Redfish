...
for the Redfish event sequencer in .csv format. It 
requires NodeJS and a set of Mockup data for each 
type of report that you want to use.
...
Hints:
If the generator is taking a long time to produce a set of
data, try lowering the time amount of data being produced,
or the number of metric reports 

You can define your own patterns in PatternFuncs.js
