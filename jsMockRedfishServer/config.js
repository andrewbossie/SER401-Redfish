      ...
      MockupPatterns: [
         {
            ...
            MetricValueTemplate: {
               ...
               TimeStamp: "#timestamp",
               MetricProperty:
                  "/redfish/v1/Chassis/Tray_1/CPU/CPUControl/1/CPUUtil"
            }
         },
         {
            ...
            MetricValueTemplate: {
               ...
               TimeStamp: "#timestamp",
               MetricProperty:
                  "/redfish/v1/Chassis/Tray_1/CPU/CPUControl/2/CPUUtil"
            }
         },
         {
            ...
            MetricValueTemplate: {
               ...
               TimeStamp: "#timestamp",
               MetricProperty:
                  "/redfish/v1/Chassis/Tray_1/CPU/CPUControl/3/CPUUtil"
            }
         }
      ]
   }
